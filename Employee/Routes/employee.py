...
@employee_route.route("/add_employee", methods=["POST"]) 
...
class SearchByName(Resource):
    ...
    @employee_route.doc( params={ "name": "Employee name or part of the name to search for"})
    def get(self):
...
@employee_route.route("/employee_by_id/<int:id>")  
...
@employee_route.route( "/update_employee/<int:id>", methods=["PUT"] ) 
...
@employee_route.route( "/delete_employee/<int:id>", methods=["DELETE"] )  
...
@employee_route.route("/get_pdf_data")  
...
@employee_route.route("/get_data_csv") 
